...
function PeopleDetail() {
  ...
  return (
    <div className='min-h-screen w-full bg-zinc-900 text-white py-6 px-16'>
      <span className='text-2xl cursor-pointer' onClick={() => navigate(-1)}>
        <IoMdArrowRoundBack />
      </span>
      <div className='flex gap-16 mt-6'>
        <div className='w-fit max-w-[10rem] shrink-0'>
          <img src={`https://image.tmdb.org/t/p/original${data.detail.profile_path}`} className='h-[15rem] shadow-xl' />
          <hr className='my-8' />
          <span className='flex items-center justify-center gap-4'>
            {
              [
                ...
                <a key={index} href={item.navigateTo} className='text-xl'>{item.icon}</a>
              ))
            }
          </span>
          <div className='mt-6'>
            ...
            <div>
              {
                [
                  ...
                  {
                    title: "Gender",
                    desc: data.detail.gender === 1 ? "Female" : "Male" || "No Information"
                  },
                  {
                    title: "Birthday",
                  ...
                  {
                    title: "Also Known As",
                    desc: data.detail.also_known_as.join(", ") || "No Information"
                  },
                ].map((item, index) => (
        ...
        <div className='flex-grow'>
            ...
            <div className='w-[70vw] mx-auto max-w-full bg-red-20'>
              <CardsScrollContainer 
                data={data.movieCredits.cast || data.tvCredits.cast}
